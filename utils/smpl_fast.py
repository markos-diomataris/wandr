...
import torch
from smplx.utils import SMPLHOutput, SMPLXOutput
...
def fast_lbs(
    ...
    J_transformed, _ = batch_rigid_transform(rot_mats, J, parents, dtype=dtype)
...
def smplh_forward_fast(
    ...
    **kwargs
        ...
        joints = fast_lbs(betas, full_pose, self.v_template,
        ...
        output = SMPLHOutput(vertices=None,
                             joints=joints,
                             betas=betas,
...
def smplx_forward_fast(
    ...
    **kwargs
    ...
    joints = fast_lbs(shape_components, full_pose, self.v_template,
    ...
    # else:
    v_shaped = Tensor(0)
    output = SMPLXOutput(vertices=None if return_verts else None,
                            joints=joints,
                            betas=betas,
